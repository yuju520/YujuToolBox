...
get_latest_version(){
    ...
    init_script_link="https://raw.githubusercontent.com/yuju520/YujuToolBox/refs/heads/main/shadowsocks-libev-debian"
}
...
pre_install(){
    ...
    read -p "(Default password: yuju.love):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="yuju.love"
    echo
    echo "---------------------------"
